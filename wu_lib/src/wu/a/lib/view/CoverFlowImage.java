 ...
 */
public class CoverFlowImage extends Gallery {
    ...
    public CoverFlowImage(final Context context) {
        super(context);
        init();
    }

    public CoverFlowImage(final Context context, final AttributeSet attrs) {
        this(context, attrs, android.R.attr.galleryStyle);
        init();
    }

    public CoverFlowImage(final Context context, final AttributeSet attrs, final int defStyle) {
    ...
    public void setAdapter(final SpinnerAdapter adapter) {
        ...
        if (adapter instanceof CoverFlowImageViewAdapter) {
        	CoverFlowImageViewAdapter coverFlowViewAdapter = (CoverFlowImageViewAdapter)adapter;
            coverFlowViewAdapter.setCoverFlowImage(this);
    ...
    private void parseAttributes(final Context context, final AttributeSet attrs) {
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CoverFlowImage);
        try {
            imageWidth = a.getDimension(R.styleable.CoverFlowImage_imageWidth, 480);
            imageHeight = a.getDimension(R.styleable.CoverFlowImage_imageHeight, 320);
            withReflection = a.getBoolean(R.styleable.CoverFlowImage_withReflection, false);
            imageReflectionRatio = a.getFloat(R.styleable.CoverFlowImage_imageReflectionRatio, 0.2f);
            reflectionGap = a.getDimension(R.styleable.CoverFlowImage_reflectionGap, 4);
            setSpacing(-15);
        } finally {
            a.recycle();
        }
    ...
    public Object getCoverFlowImageSelectedItem() {
    	CoverFlowImageViewAdapter coverFlowViewAdapter = (CoverFlowImageViewAdapter)getAdapter();
        Object o = coverFlowViewAdapter.getDatas().get(getSelectedItemPosition());
        return o;

    }

    private OnCoverFlowImageItemSelectedListener onCoverFlowItemSelectedListener;

    public OnCoverFlowImageItemSelectedListener getOnCoverFlowImageItemSelectedListener() {
        return onCoverFlowItemSelectedListener;
    }

    public void setOnCoverFlowImageItemSelectedListener(
            OnCoverFlowImageItemSelectedListener onCoverFlowItemSelectedListener) {
        this.onCoverFlowItemSelectedListener = onCoverFlowItemSelectedListener;
    }

    public interface OnCoverFlowImageItemSelectedListener {
