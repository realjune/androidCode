...
public class ShareCompat
{
  ...
  public static class IntentBuilder
  {
    ...
    public Intent getIntent()
    {
      ...
      {
        label86: boolean bool = this.mIntent.getAction().equals("android.intent.action.SEND_MULTIPLE");
        if ((i == 0) && (bool))
        {
  ...
  public static class IntentReader
  {
    ...
    public String getHtmlText()
    {
      ...
      for (str = Html.toHtml((Spanned)localCharSequence); ; str = ShareCompat.IMPL.escapeHtml(localCharSequence))
        label39: 
        do
          return str;
    ...
    public int getStreamCount()
    {
      if ((this.mStreams == null) && (isMultipleShare()))
        this.mStreams = this.mIntent.getParcelableArrayListExtra("android.intent.extra.STREAM");
      if (this.mStreams != null);
      for (int i = this.mStreams.size(); ; i = 0)
        while (true)
        {
          return i;
