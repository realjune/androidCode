  ...
  implements Iterable<Intent>
{
  ...
  public TaskStackBuilder addParentStack(ComponentName paramComponentName)
  {
    ...
    try
    {
      Object localObject = NavUtils.getParentActivityIntent(this.mSourceContext, paramComponentName);
      if (localObject == null)
        break label72;
      this.mIntents.add(i, localObject);
      Intent localIntent = NavUtils.getParentActivityIntent(this.mSourceContext, ((Intent)localObject).getComponent());
    ...
    label72: return (TaskStackBuilder)this;
  }
