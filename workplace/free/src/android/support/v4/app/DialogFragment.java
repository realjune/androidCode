  ...
  implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener
{
  ...
  public LayoutInflater getLayoutInflater(Bundle paramBundle)
  {
    ...
    for (LayoutInflater localLayoutInflater = super.getLayoutInflater(paramBundle); ; localLayoutInflater = (LayoutInflater)this.mActivity.getSystemService("layout_inflater"))
    {
      label13: return localLayoutInflater;
