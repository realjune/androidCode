...
public class PalladiumGBView extends ListActivity
{
  ...
  private List<News> getRss(String paramString)
  {
    ...
    localNews1.setLink("http://www.kitco.cn/cn/live_charts/tny_pd_ch_hkdoz_165x125.gif");
    localArrayList.add(localNews1);
    News localNews2 = new News();
    localNews2.setTitle("24小时(盎司)");
    localNews2.setLink("http://www.kitco.cn/cn/live_charts/t24_pd_ch_hkdoz_165x125.gif");
    localArrayList.add(localNews2);
    News localNews3 = new News();
    localNews3.setTitle("8小时(公斤)");
    localNews3.setLink("http://www.kitco.cn/cn/live_charts/tny_pd_ch_hkdkg_165x125.gif");
    localArrayList.add(localNews3);
    News localNews4 = new News();
    localNews4.setTitle("24小时(公斤)");
    localNews4.setLink("http://www.kitco.cn/cn/live_charts/t24_pd_ch_hkdkg_165x125.gif");
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.btnBack.setOnClickListener(new PalladiumGBView.1(this));
  }
 ...
 * Qualified Name:     com.zrh.goldfree.PalladiumGBView
