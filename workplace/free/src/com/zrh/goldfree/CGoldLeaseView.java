...
public class CGoldLeaseView extends ListActivity
{
  ...
  private List<News> getRss(String paramString)
  {
    ...
    localNews1.setLink("http://www.kitconet.com/charts/metals/leaserates/au_go_0030_lsb.gif");
    localArrayList.add(localNews1);
    News localNews2 = new News();
    localNews2.setTitle("60天");
    localNews2.setLink("http://www.kitconet.com/charts/metals/leaserates/au_go_0060_lsb.gif");
    localArrayList.add(localNews2);
    News localNews3 = new News();
    localNews3.setTitle("6月");
    localNews3.setLink("http://www.kitconet.com/charts/metals/leaserates/au_go_0182_lsb.gif");
    localArrayList.add(localNews3);
    News localNews4 = new News();
    localNews4.setTitle("1年");
    localNews4.setLink("http://www.kitconet.com/charts/metals/leaserates/au_go_0365_lsb.gif");
    localArrayList.add(localNews4);
    News localNews5 = new News();
    localNews5.setTitle("详图");
    localNews5.setLink("http://www.sharelynx.com/chartstemp/charts11/kitco2aulrates.php");
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.btnBack.setOnClickListener(new CGoldLeaseView.1(this));
  }
 ...
 * Qualified Name:     com.zrh.goldfree.CGoldLeaseView
