...
public class PalladiumLeaseView extends ListActivity
{
  ...
  private List<News> getRss(String paramString)
  {
    ...
    localNews1.setLink("http://www.kitconet.com/charts/metals/leaserates/pd_go_0030_lsb.gif");
    localArrayList.add(localNews1);
    News localNews2 = new News();
    localNews2.setTitle("60天");
    localNews2.setLink("http://www.kitconet.com/charts/metals/leaserates/pd_go_0060_lsb.gif");
    localArrayList.add(localNews2);
    News localNews3 = new News();
    localNews3.setTitle("6月");
    localNews3.setLink("http://www.kitconet.com/charts/metals/leaserates/pd_go_0182_lsb.gif");
    localArrayList.add(localNews3);
    News localNews4 = new News();
    localNews4.setTitle("1年");
    localNews4.setLink("http://www.kitconet.com/charts/metals/leaserates/pd_go_0365_lsb.gif");
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.btnBack.setOnClickListener(new PalladiumLeaseView.1(this));
  }
 ...
 * Qualified Name:     com.zrh.goldfree.PalladiumLeaseView
