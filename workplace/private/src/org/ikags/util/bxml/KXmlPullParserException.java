...
public class KXmlPullParserException extends Exception
{
   ...
   */
  public KXmlPullParserException(String s)
  {
    super(s);
  }

  /*
   * public XmlPullParserException(String s, Throwable thrwble) { super(s); this.detail = thrwble; } public XmlPullParserException(String s, int row, int column) { super(s);
   * this.row = row; this.column = column; }
   */
  public KXmlPullParserException(String msg, KXmlPullParser parser, Throwable chain)
  {
