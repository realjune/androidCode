...
public class SettingModel extends DataBaseModel {
    ...
    // o sorting = 2  amount ASC
    // o sorting = 3  amount DESC
  ...
  //  public static final int SORT_DATE_ASC = 0;
    ...
    public void save(Context context){
        BankSqliteHelper bankSqliteHelper = BankSqliteHelper.getInstance(context);
        boolean flag = bankSqliteHelper.update(this);
        if(flag) {
           
          DialogManager.createMessageDialog(context.getResources().getString(R.string.save_success), context).show();
        }
    }
}
