...
public class AggregatedViewManager extends MainMenuSubScreenManager implements
    ...
    protected void showChart(ViewGroup chartLayout) {
        ...
        horizontalChartView.setTotalAssetText("Total assets " + totalAssets);
...
//            			handler.sendEmptyMessage(-1);
    ...
    private void updateUI(long date) {
        ...
        creditCardPercentages = getPercentages(accountSum, investmentsSum, prepaidCardsSum,creditCardNum);
    ...
    protected void setUI() {
        ...
        dashBoardManager.setWellcomeText("Welcome " + welcomeText);
        ...
        Drawable closeDrawable = activity.getResources().getDrawable(
                R.drawable.investments_legend_closed);
        Drawable openDrawable = activity.getResources().getDrawable(
                R.drawable.investments_legend_opened);
        if (Contants.investmentAccounts != null && Contants.investmentAccounts.size() != 0) {
            String investmentAmount = Utils.formatMoney(investmentsSum, activity.getResources()
                    .getString(R.string.dollar), true, true, false, false, true);
            legendItemText.setData(activity.getResources().getString(R.string.legend_investments),
                    investmentAmount, closeDrawable, openDrawable);
            // 添加Investments的圆球;k
        ...
        if (Contants.creditCardAccounts != null && Contants.creditCardAccounts.size() != 0) {
            ...
            wheelButton
                    .setmCenterUserWeightCount((float)(accountSum + investmentsSum + prepaidCardsSum));
            centerChartButton = new WheelButtonItem();
        ...
        String title = "Payed loans / Outstanding loans";
