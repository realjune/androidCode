...
import com.act.mbanking.bean.BalanceAccountsModel;
import com.act.mbanking.bean.GetBalanceResponseModel;
	...
	public static GetBalanceResponseModel parseGetBalanceResponse(String json) {
        ...
        try {
            ...
            for(int i=0;i<accountsArray.length();i++){
            	...
            	banlanceAccount.setAvailableBalance(accountsArray.optJSONObject(i).optInt("availableBalance"));
