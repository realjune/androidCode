...
public class GetPushPreferencesJson {
    /**
    ...
    public static String GetPushPreferencesReportProtocal(RequestPublicModel publicModel,String applicationId) {
        ...
        try {
            ...
            getPushPreferencesRequest.put("serviceType", ServiceType.GETPUSHPREFERENCES);
    ...
    public static GetPushPreferencesModel ParseGetPushPreferencesResponse(String json) {
        GetPushPreferencesModel getPushPreferencesModel = new GetPushPreferencesModel();
