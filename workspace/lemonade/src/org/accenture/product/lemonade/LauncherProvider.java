...
public class LauncherProvider extends ContentProvider
{
	...
	public static final String AUTHORITY = "org.accenture.product.lemonade.settings";
	...
	public static class DatabaseHelper extends SQLiteOpenHelper
	{
		...
		public void onCreate(SQLiteDatabase db)
		{
			...
			db.execSQL("CREATE TABLE favorites (" + "_id INTEGER PRIMARY KEY," + "title TEXT," + "intent TEXT,"
					...
					+ "isShortcut INTEGER," + "iconType INTEGER," + "iconPackage TEXT," + "iconResource TEXT," + "icon BLOB,"
					+ "uri TEXT," + "displayMode INTEGER," + "scene INTEGER" + ");");
		 ...
		 * @param db
		 */
		// private void initAPP(SQLiteDatabase db)
		// {
		// ContentValues values = new ContentValues();
		// values
		// .put(
		// "intent",
		// "#Intent;action=android.intent.action.MAIN;category=android.intent.category.LAUNCHER;launchFlags=0x10200000;component=com.google.android.googlequicksearchbox/.SearchActivity;end");
		...
		// String intent =
		// "#Intent;action=android.intent.action.MAIN;category=android.intent.category.LAUNCHER;launchFlags=0x10200000;component=com.google.android.googlequicksearchbox/.SearchActivity;end";
		// // int i = (int) db.insert(TABLE_FAVORITES, null, values);
		// // addInitAPP(db, intent, -100, 4, 0, 3, 1, 1, 1, -1, 0, 1);
		//
		// intent =
		...
		// // addInitAPP(db, intent, -100, 4, 1, 3, 1, 1, 1, -1, 0, 1);
		//
		// intent =
		// "#Intent;action=android.intent.action.MAIN;category=android.intent.category.LAUNCHER;launchFlags=0x10200000;component=com.android.mms/.ui.ConversationList;end";
		// // addInitAPP(db, intent, -100, 4, 2, 3, 1, 1, 1, -1, 0, 1);
		//
		// intent =
		// "#Intent;action=android.intent.action.MAIN;category=android.intent.category.LAUNCHER;launchFlags=0x10200000;component=com.android.vending/.AssetBrowserActivity;end";
		// // addInitAPP(db, intent, -100, 4, 3, 3, 1, 1, 1, -1, 0, 1);
		//
		// intent =
		// "#Intent;action=android.intent.action.MAIN;category=android.intent.category.LAUNCHER;launchFlags=0x10200000;component=com.google.android.apps.maps/com.google.android.maps.MapsActivity;end";
		// // addInitAPP(db, intent, -100, 4, 0, 2, 1, 1, 1, -1, 0, 1);
		//
		// intent =
		// "#Intent;action=android.intent.action.MAIN;category=android.intent.category.LAUNCHER;launchFlags=0x10200000;component=com.google.android.camera/com.android.camera.Camera;end";
		// addInitAPP(db, intent, -100, 4, 1, 2, 1, 1, 1, -1, 0, 1);
		//
		// intent =
		// "#Intent;action=android.intent.action.MAIN;category=android.intent.category.LAUNCHER;launchFlags=0x10200000;component=com.android.browser/.BrowserActivity;end";
		// // addInitAPP(db, intent, -100, 4, 2, 2, 1, 1, 1, -1, 0, 1);
		//
		// intent =
		// "#Intent;action=android.intent.action.MAIN;category=android.intent.category.LAUNCHER;launchFlags=0x10200000;component=com.android.contacts/.DialtactsContactsEntryActivity;end";
		// addInitAPP(db, intent, -100, 4, 2, 2, 1, 1, 1, -1, 0, 1);
		//
		// // for Scene 2
		// intent =
		// "#Intent;action=android.intent.action.MAIN;category=android.intent.category.LAUNCHER;launchFlags=0x10200000;component=com.google.android.googlequicksearchbox/.SearchActivity;end";
		// // int i = (int) db.insert(TABLE_FAVORITES, null, values);
		// addInitAPP(db, intent, -100, 4, 0, 3, 1, 1, 1, -1, 0, 2);
		//
		// intent =
		// "#Intent;action=android.intent.action.MAIN;category=android.intent.category.LAUNCHER;launchFlags=0x10200000;component=com.google.android.gm/.ConversationListActivityGmail;end";
		// addInitAPP(db, intent, -100, 4, 1, 3, 1, 1, 1, -1, 0, 2);
		//
		// intent =
		// "#Intent;action=android.intent.action.MAIN;category=android.intent.category.LAUNCHER;launchFlags=0x10200000;component=com.android.mms/.ui.ConversationList;end";
		// addInitAPP(db, intent, -100, 4, 2, 3, 1, 1, 1, -1, 0, 2);
		//
		// intent =
		// "#Intent;action=android.intent.action.MAIN;category=android.intent.category.LAUNCHER;launchFlags=0x10200000;component=com.android.vending/.AssetBrowserActivity;end";
		// addInitAPP(db, intent, -100, 4, 3, 3, 1, 1, 1, -1, 0, 2);
		//
		// intent =
		// "#Intent;action=android.intent.action.MAIN;category=android.intent.category.LAUNCHER;launchFlags=0x10200000;component=com.google.android.apps.maps/com.google.android.maps.MapsActivity;end";
		// addInitAPP(db, intent, -100, 4, 0, 2, 1, 1, 1, -1, 0, 2);
		//
		// intent =
		// "#Intent;action=android.intent.action.MAIN;category=android.intent.category.LAUNCHER;launchFlags=0x10200000;component=com.google.android.camera/com.android.camera.Camera;end";
		// addInitAPP(db, intent, -100, 4, 1, 2, 1, 1, 1, -1, 0, 2);
		//
		// intent =
		// "#Intent;action=android.intent.action.MAIN;category=android.intent.category.LAUNCHER;launchFlags=0x10200000;component=com.android.browser/.BrowserActivity;end";
		// addInitAPP(db, intent, -100, 4, 2, 2, 1, 1, 1, -1, 0, 2);
		//
		// intent =
		// "#Intent;action=android.intent.action.MAIN;category=android.intent.category.LAUNCHER;launchFlags=0x10200000;component=com.android.contacts/.DialtactsContactsEntryActivity;end";
		// addInitAPP(db, intent, -100, 4, 3, 2, 1, 1, 1, -1, 0, 2);
		// }
		private void initAPP(SQLiteDatabase db)
		{
			ContentValues values = new ContentValues();
			...
			String message = "#Intent;action=android.intent.action.MAIN;category=android.intent.category.LAUNCHER;launchFlags=0x10200000;component=com.android.mms/.ui.ConversationList;end";
			addInitAPP(db, message, -100, 3, 0, 3,1, 1, 1, -1, 0, 1);
			String email = "#Intent;action=android.intent.action.MAIN;category=android.intent.category.LAUNCHER;launchFlags=0x10200000;component=com.google.android.gm/.ConversationListActivityGmail;end";
			addInitAPP(db, email, -100, 3, 1, 3,1, 1, 1, -1, 0, 1);

			String browser = "#Intent;action=android.intent.action.MAIN;category=android.intent.category.LAUNCHER;launchFlags=0x10200000;component=com.android.browser/.BrowserActivity;end";
			addInitAPP(db, browser, -100, 3, 2, 3,1, 1, 1, -1, 0, 1);

			String calendar = "#Intent;action=android.intent.action.MAIN;category=android.intent.category.LAUNCHER;launchFlags=0x10200000;component=com.google.android.calendar/com.android.calendar.LaunchActivity;end";
			addInitAPP(db, calendar, -100, 3, 3, 3,1, 1, 1, -1, 0, 1);

			// for Social2
			String contacts = "#Intent;action=android.intent.action.MAIN;category=android.intent.category.LAUNCHER;launchFlags=0x10200000;component=com.android.contacts/.DialtactsContactsEntryActivity;end";
			addInitAPP(db, contacts, -100, 3, 0, 3,1, 1, 1, -1, 0, 2);
			addInitAPP(db, message, -100, 3, 1, 3,1, 1, 1, -1, 0, 2);
			addInitAPP(db, browser, -100, 3, 2, 3,1, 1, 1, -1, 0, 2);
			addInitAPP(db, calendar, -100, 3, 3, 3,1, 1, 1, -1, 0, 2);

			// for Business3
			addInitAPP(db, contacts, -100, 3, 0, 3,1, 1, 1, -1, 0, 3);
			addInitAPP(db, email, -100, 3, 1, 3,1, 1, 1, -1, 0, 3);
			addInitAPP(db, browser, -100, 3, 2, 3,1, 1, 1, -1, 0, 3);
			String map = "#Intent;action=android.intent.action.MAIN;category=android.intent.category.LAUNCHER;launchFlags=0x10200000;component=com.google.android.apps.maps/com.google.android.maps.MapsActivity;end";
			addInitAPP(db, map, -100, 3, 3, 3,1, 1, 1, -1, 0, 3);

			// for Entertainment4
			addInitAPP(db, contacts, -100, 3, 0, 3,1, 1, 1, -1, 0, 4);
			addInitAPP(db, map, -100, 3, 1, 3,1, 1, 1, -1, 0, 4);
			addInitAPP(db, browser, -100, 3, 2, 3,1, 1, 1, -1, 0, 4);
			...
			addInitAPP(db, camera, -100, 3, 3, 3,1, 1, 1, -1, 0, 6);
		 ...
		 * @param scene
		 */
		private void addInitAPP(SQLiteDatabase db, String intent, int container, int screen, int cellX, int cellY, int spanX,
				int spanY, int itemType, int appWidgetId, int iconType, int scene)
		{
			ContentValues values = new ContentValues();
		...
		{
			Cursor c = null;
			final String selectWhere = buildOrWhereString(Favorites.ITEM_TYPE, new int[]
			...
			try
			{
				...
				{ Favorites._ID, Favorites.INTENT }, selectWhere, null, null, null, null);
		...
		private void normalizeIcons(SQLiteDatabase db)
		{
			...
			try
			{
				...
				while (c.moveToNext())
				{
					...
					try
					{
						Bitmap bitmap = Utilities.resampleIconBitmap(BitmapFactory.decodeByteArray(data, 0, data.length),
								mContext);
						if (bitmap != null)
						{
		...
		private void convertWidgets(SQLiteDatabase db)
		{
			...
			try
			{
				// Select and iterate through each matching widget
				c = db.query(TABLE_FAVORITES, new String[]
				{ Favorites._ID, Favorites.ITEM_TYPE }, selectWhere, null, null, null, null);
		...
		private boolean addAppShortcut(SQLiteDatabase db, ContentValues values, TypedArray a, PackageManager packageManager,
				Intent intent)
		{
		...
		private ComponentName getSearchWidgetProvider()
		{
			 ...
			 * mContext.getSystemService(Context.SEARCH_SERVICE); ComponentName
			 * searchComponent = searchManager.getGlobalSearchActivity(); if
			 * (searchComponent == null) return null; return
			 * getProviderInPackage(searchComponent.getPackageName());
			 */
			return null;
		}
		...
		{
			SQLiteDatabase _SQLiteDatabase = getWritableDatabase();
			//			
			// db.execSQL("CREATE TABLE favorites (" +
			// "_id INTEGER PRIMARY KEY," + "title TEXT," + "intent TEXT,"
			// + "container INTEGER," + "screen INTEGER," + "cellX INTEGER," +
			// "cellY INTEGER," + "spanX INTEGER,"
			// + "spanY INTEGER," + "itemType INTEGER," +
			// "appWidgetId INTEGER NOT NULL DEFAULT -1,"
			// + "isShortcut INTEGER," + "iconType INTEGER," +
			// "iconPackage TEXT," + "iconResource TEXT," + "icon BLOB,"
			// + "uri TEXT," + "displayMode INTEGER," + "scene INTEGER" + ");");
			String where = "screen = ? and scene = ?";
			String args[] =
			{ String.valueOf(screen), String.valueOf(sceneId) };
			_SQLiteDatabase.delete("favorites", where, args);
		...
		{
			SQLiteDatabase _SQLiteDatabase = getWritableDatabase();
			String selection = "screen >? and scene = ?";
			String selectionArgs[] =
			{ String.valueOf(index), String.valueOf(sceneId) };
			Cursor c = _SQLiteDatabase.query("favorites", null, selection, selectionArgs, null, null, null);
			...
			for (c.moveToFirst(); !c.isAfterLast(); c.moveToNext())
			{
				...
				int screenIndex = c.getColumnIndex("screen");
		...
		private void doUpdateScreenIndex(int[] id_index, boolean upcase)
		{
			SQLiteDatabase _SQLiteDatabase = getWritableDatabase();
			...
			if (upcase)
			{
				values.put("screen", id_index[1] + 1);
			...
			_SQLiteDatabase.update("favorites", values, selection, selectionArgs);
