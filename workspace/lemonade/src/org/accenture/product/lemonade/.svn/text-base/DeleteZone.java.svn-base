...
//			return;
		...
		else if (item instanceof LauncherAppWidgetInfo)
		{
			...
			if (appWidgetHost != null)
			{
				...
				mLauncher.getModel().deleteWidgetFromDatabase(mLauncher, item);
			}
		}
		mLauncher.getModel().deleteItemFromDatabase(mLauncher, item);
	}
	...
	private void createAnimations()
	{
		if (mInAnimation == null)
		{
			...
			{
				animationSet.addAnimation(new TranslateAnimation(Animation.RELATIVE_TO_SELF, 1.0f, Animation.RELATIVE_TO_SELF,
		...
		if (mOutAnimation == null)
		{
			...
			if (mOrientation == ORIENTATION_HORIZONTAL)
			{
				animationSet.addAnimation(new FastTranslateAnimation(Animation.ABSOLUTE, 0.0f, Animation.ABSOLUTE, 0.0f,
