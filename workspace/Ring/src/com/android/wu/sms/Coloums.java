...
public final class Coloums {
	...
	public static final class SMSLog implements BaseColumns {
		...
		/** 默认排序常量 */
		public static final String DEFAULT_SORT_ORDER = "date DESC";// 按时间排�?
		...
		static{
			SMS_TYPE_NAME.put(Sms.MESSAGE_TYPE_DRAFT, "�ݸ�");
			SMS_TYPE_NAME.put(Sms.MESSAGE_TYPE_FAILED, "����ʧ��");
			SMS_TYPE_NAME.put(Sms.MESSAGE_TYPE_INBOX, "�յ�");
			SMS_TYPE_NAME.put(Sms.MESSAGE_TYPE_OUTBOX, "����");
			SMS_TYPE_NAME.put(Sms.MESSAGE_TYPE_SENT, "����");
		}
