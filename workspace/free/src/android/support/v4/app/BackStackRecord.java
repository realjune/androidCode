  ...
  implements FragmentManager.BackStackEntry, Runnable
{
    ...
    for (int i = 0; localOp != null; ++i)
    {
      ...
      default:
        ...
        if ((localOp.removed != null) && (localOp.removed.size() > 0))
        {
          ...
          {
            label641: paramPrintWriter.print(str1);
  ...
  public void popFromBackStack(boolean paramBoolean)
  {
    ...
    if (localOp != null)
    {
      ...
      case 1:
        label67: Fragment localFragment8 = localOp.fragment;
    ...
    if (localOp != null)
    {
      ...
      while (true)
      {
        ...
        if (this.mManager.mAdded != null)
        {
          ...
          {
            label199: Fragment localFragment7 = (Fragment)this.mManager.mAdded.get(i);
            if (FragmentManagerImpl.DEBUG)
            ...
            while (true)
            {
              ...
              break label199:
              if (localOp.removed == null)
                label314: localOp.removed = new ArrayList();
