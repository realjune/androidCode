...
public class SilverStageView extends ListActivity
{
  ...
  private List<News> getRss(String paramString)
  {
    ...
    localNews1.setLink("http://www.kitco.cn/cn/live_charts/kitcocn/t24_ag_rmbg_cn.gif");
    localArrayList.add(localNews1);
    News localNews2 = new News();
    localNews2.setTitle("30天(人民币)");
    localNews2.setLink("http://www.kitco.cn/cn/live_charts/kitcocn/t30d_ag_rmbg_cn.gif");
    localArrayList.add(localNews2);
    News localNews3 = new News();
    localNews3.setTitle("一年(人民币)");
    localNews3.setLink("http://www.kitco.cn/cn/live_charts/kitcocn/t365d_ag_rmbg_cn.gif");
    localArrayList.add(localNews3);
    News localNews4 = new News();
    localNews4.setTitle("24小时(美元)");
    localNews4.setLink("http://www.kitco.cn/cn/live_charts/kitcocn/t24_ag_usoz_cn.gif");
    localArrayList.add(localNews4);
    News localNews5 = new News();
    localNews5.setTitle("30天(美元)");
    localNews5.setLink("http://www.kitco.cn/cn/live_charts/kitcocn/t30d_ag_usoz_cn.gif");
    localArrayList.add(localNews5);
    News localNews6 = new News();
    localNews6.setTitle("一年(美元)");
    localNews6.setLink("http://www.kitco.cn/cn/live_charts/kitcocn/t365d_ag_usoz_cn.gif");
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.btnBack.setOnClickListener(new SilverStageView.1(this));
  }
 ...
 * Qualified Name:     com.zrh.goldfree.SilverStageView
