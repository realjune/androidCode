...
public class GoldZoushiView extends Activity
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    for (str = "http://www.kitco.cn/cn/search_charts/gold/au_LF_" + this.mNian + ".gif"; ; str = "http://www.kitco.cn/cn/hist_charts/gold/24_hours/" + this.mNian + "/cn_au" + inttostr(this.mYue) + inttostr(this.mRi) + this.mNian + ".gif")
      do
        while (true)
        {
          ...
          if (this.mCurrRadio != 2)
            break;
          str = "http://www.kitco.cn/cn/search_charts//gold/au_lf_" + this.mNian + "_" + this.mYue + ".gif";
        }
 ...
 * Qualified Name:     com.zrh.goldfree.GoldZoushiView
