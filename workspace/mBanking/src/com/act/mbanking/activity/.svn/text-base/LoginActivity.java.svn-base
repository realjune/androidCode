...
import com.act.mbanking.logic.GetPaymentTemplatesJson;
...
public class LoginActivity extends BaseActivity implements OnClickListener, OnCheckedChangeListener {
    ...
    private SimpleImageButton safety_btn;

    private SimpleImageButton locate_btn;

    private SimpleImageButton demo_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        safety_btn = (SimpleImageButton)findViewById(R.id.safety_btn);
        safety_btn.setOnClickListener(this);
        locate_btn = (SimpleImageButton)findViewById(R.id.locate_btn);
        locate_btn.setOnClickListener(this);
        demo_btn = (SimpleImageButton)findViewById(R.id.demo_btn);
        ...
        if (view == adv) {
            ...
            Thread thread = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    updateProgressDetail("Validate Password...");
                    ...
                    updateProgressDetail("Restore User Info...");

                    updateProgressDetail("Downloading User Info...");
                	...
                	//
                	updateProgressDetail("Downloading Accounts...");
      	...
      	updateProgressDetail("Download RecipientList...");
      	...
      	if (App.app.getRecipientListModel == null) {
      		...
      		return;
                    ...
                    // ??
                    updateProgressDetail("Download Cards SynchChart....");
                    ...
                    // ?
                    updateProgressDetail("Download Account SynchChart....");
                    ...
                    // ??
                    updateProgressDetail("Download Investments SynchChart....");
                    ...
                    // ??
                    updateProgressDetail("Download Financing SynchChart....");
                    ...
                    // ??
                    updateProgressDetail("Download Cards SynchDashBoard....");
                    progressThread.setProgress(75);
                    ...
                    // ??
                    updateProgressDetail("Download Account SynchDashBoard....");
                    ...
                    // ??
                    updateProgressDetail("Download Investments SynchDashBoard....");
                    ...
                    // ??
                    updateProgressDetail("Download Financing SynchDashBoard....");
                    ...
                    updateProgressDetail("Save Local DataBase....");
