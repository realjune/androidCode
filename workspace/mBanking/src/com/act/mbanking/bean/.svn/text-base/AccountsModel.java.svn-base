...
public class AccountsModel implements Serializable {
    ...
    /**
     * @param dashboardAggregatedAccountsList the
     *            dashboardAggregatedAccountsList to set
     */
    ...
    /**
     * @param chartAggregatedAccountsList the chartAggregatedAccountsList to set
     */
    public void setChartAggregatedAccountsList(List<AggregatedAccount> chartAggregatedAccountsList) {
    ...
    /**
     * @param payedloan the payedloan to set
     */
    ...
    /**
     * @param outstandingloan the outstandingloan to set
     */
