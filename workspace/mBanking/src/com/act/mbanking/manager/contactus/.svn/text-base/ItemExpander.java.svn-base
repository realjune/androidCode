...
import com.act.mbanking.manager.contactus.ExpandedContainer.ExpandBarResultChangeListener;
...
//                closeKeyboard();
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        resultText.requestFocus();
        KeyBoardUtils.hideSoftInputFromWindow(getContext(),resultText.getWindowToken());
    }
