    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if ((category != "expand")) {
            ...
            for (PushSettingModel pushSettingModel : pushSettingList) {
                ...
                tv.setText(itemName);
                ToggleButton buttonSetting = (ToggleButton)v.findViewById(R.id.toggleButton1);
                ...
                if (settingValue == 1) {
                    ...
                    buttonSetting.setText(cxt.getResources().getString(R.string.on));
                } else {
                    buttonSetting.setChecked(false);
                    buttonSetting.setText(cxt.getResources().getString(R.string.off));
                }
