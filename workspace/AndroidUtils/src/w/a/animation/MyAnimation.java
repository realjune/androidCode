...
/*
 Android实现图片的倒影效果  Android 的 Matrix 解析一
 Android 自定义Animation动画  2011-08-19 10:30:59|  分类： android动画 |  标签： |举报 |字号大
 中
 小 订阅 
 ...
 每次调用参数interpolatedTime值都会变化，该参数从0渐变为1，当该参数为1时表明动画结束。
