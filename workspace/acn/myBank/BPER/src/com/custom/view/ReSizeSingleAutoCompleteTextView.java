 ...
 *
 */
public class ReSizeSingleAutoCompleteTextView extends AutoCompleteTextView {
	
	public ReSizeSingleAutoCompleteTextView(Context context) {
		super(context);
		initialise();
	}
	
	public ReSizeSingleAutoCompleteTextView(Context context, AttributeSet attrs) {
		super(context, attrs);
