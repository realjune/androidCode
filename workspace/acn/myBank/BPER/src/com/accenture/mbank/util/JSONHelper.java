...
public class JSONHelper {
     ...
     * @param value
     */
    public static void setFiedlValue(Object obj, Method fieldSetMethod, String fieldType,
            Object value) {
        ...
        try {
            if (null != value && !"".equals(value)) {
                if ("String".equals(fieldType)) {
                    ...
                    LogManager.e( TAG + ">>>>setFiedlValue -> not supper type" + fieldType);
                }
            }
     ...
     * @throws JSONException
     */
    public static String parseOjbect(String jsonStr, String objName) throws JSONException {
        String value = null;
        if (jsonStr != null && jsonStr.length() != 0) {
            ...
            if (isNull(jo)) {
                ...
                value = jo.optString(objName).toString();
            }
        }
        return value;
    }
