...
public class DateDescriptionCorporateAmountItem extends LinearLayout {
    ...
    private LinearLayout childListView;
    ...
    public DateDescriptionCorporateAmountItem(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
	...
	public void init(final LinearLayout childListView, final int listSize,final Context context) {
    ...
    private void closeOther() {
        ...
        for (int i = 0; i < parent.getChildCount(); i++) {
            ...
            if (child instanceof DateDescriptionCorporateAmountItem) {
            	DateDescriptionCorporateAmountItem itemExpander = (DateDescriptionCorporateAmountItem)child;
    ...
    void setTexts(String operationDate, String description, String amount, String currencyDate) {
        if (accountOperationDateValue == null) {
            init(childListView, listSize, context);
        }
