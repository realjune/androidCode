...
public class AemmProvider extends ContentProvider {
	...
	static final int PROVIDER_DB_VERSION = 6;
	...
	private static final String[] TABLE_NAMES = { ApkTable.APKTABLE,
			...
			TrafficTable.TRAFFIC ,Attachment.DATABASE_NAME};
	...
	private static final int ATTACHMENT_BASE = 0x7000;
	private static final int ATTACHMENTTABLE = ATTACHMENT_BASE;
	private static final int ATTACHMENTTABLE_ID = ATTACHMENT_BASE + 1;
	...
	static {
		...
		uriMatcher.addURI(PROVIDER_NAME, Attachment.DATABASE_NAME, ATTACHMENTTABLE);
		uriMatcher.addURI(PROVIDER_NAME, Attachment.DATABASE_NAME + "/#",
				ATTACHMENTTABLE_ID);
	}
}
