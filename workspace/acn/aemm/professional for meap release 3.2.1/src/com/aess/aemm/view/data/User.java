...
public class User {
	...
	public final static Map<String,Integer> mErrorInfo=new HashMap<String,Integer>();
//	public static final int SUCCESSED = "修改成功";
	static{
		mErrorInfo.put("500",R.string.n500);
		mErrorInfo.put("401",R.string.n401);
		mErrorInfo.put("402",R.string.n402);
		mErrorInfo.put("403",R.string.n403);
	}
