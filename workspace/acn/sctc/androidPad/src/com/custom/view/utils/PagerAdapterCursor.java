...
import android.widget.Filterable;
	 ...
	 * columns.
	 */
	public abstract class PagerAdapterCursor extends PagerBaseAdapter implements Filterable{ //	        CursorFilter.CursorFilterClient {
	    /**
...
//	    protected CursorFilter mCursorFilter;
	     ...
	     */
	    @Deprecated
	    public PagerAdapterCursor(Context context, Cursor c) {
	     ...
	     */
	    public PagerAdapterCursor(Context context, Cursor c, boolean autoRequery) {
	     ...
	     */
	    public PagerAdapterCursor(Context context, Cursor c, int flags) {
