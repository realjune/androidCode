...
public class PortfolioExpandedContainer extends ExpandedContainer {
    ...
    private void init() {
        if (sharesItemExpander == null) {
            ...
            bondsExpandContainer = (PortFolioDetailExpandContainer)inflater.inflate(
                    R.layout.portfolio_detail_expander, null);
            bondsItemExpander.setExpandedContainer(bondsExpandContainer);

            sharesExpandContainer = (PortFolioDetailExpandContainer)inflater.inflate(
                    R.layout.portfolio_detail_expander, null);
            sharesItemExpander.setExpandedContainer(sharesExpandContainer);

            fundsExpandContainer = (PortFolioDetailExpandContainer)inflater.inflate(
                    R.layout.portfolio_detail_expander, null);
            fundsItemExpander.setExpandedContainer(fundsExpandContainer);

            moreExpandContainer = (PortFolioDetailExpandContainer)inflater.inflate(
                    R.layout.portfolio_detail_expander, null);
    ...
    private void test() {
        ...
        PortfolioDetailItemData portfolioDetailItemData = new PortfolioDetailItemData();
        portfolioDetailItemData.title = "1000";
        portfolioDetailItemData.quantity = "1000";
        portfolioDetailItemData.price = "+10.00$";
        portfolioDetailItemData.datePrice = "2012-06-20";

        // sharesExpandContainer.add(portfolioDetailItemData);
        // bondsExpandContainer.add(portfolioDetailItemData);
        // fundsExpandContainer.add(portfolioDetailItemData);
        // moreExpandContainer.add(portfolioDetailItemData);
    }
}
