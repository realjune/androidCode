...
public class UserInfoLayoutManager extends BankRollContainerManager {
    ...
    public void createUiByData() {
        if (!isDisplay) {
            ...
            progressOverlay.show(this.getContext().getResources().getString(R.string.waitting),
                new OnProgressEvent() {
                    @Override
    ...
    private void setPushSetting(final List<PushSettingModel> pushsettinglist) {
		...
		progressOverlay.show(getContext().getResources()
				.getString(R.string.waitting), new OnProgressEvent() {
			@Override
			public void onProgress() {
    ...
    public void setPushExpandedContainer(ItemExpander itemExpander, PushCategoryModel pushCategoryModel) {
    	...
    	for (PushSettingModel pushSettingModel : pushSettingList) {
    		...
    		tv.setText(itemName);
    		ToggleButton buttonSetting = (ToggleButton) container.findViewById(R.id.toggleButton1);
    		...
    		buttonSetting.setOnClickListener( new OnClickListener() {
    			...
    			public void onClick(View v) {  
    				...
    				ToggleButton buttonSetting=(ToggleButton) v;
