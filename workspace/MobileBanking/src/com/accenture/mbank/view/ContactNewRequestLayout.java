...
public class ContactNewRequestLayout extends ExpandedContainer implements
        ...
        send_request.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (topicOfInterest == null) {
                    Toast.makeText(getContext(), "Object cann't be empty", Toast.LENGTH_LONG)
                            .show();
                    return;
                }
                ...
                if (contactMode.equals(InsertCommunicationJson.CONTACT_MODE_EMAIL)
                    ...
                    if (userInfo.user_email.isEmpty()) {
                        Toast.makeText(getContext(), "Email cann't be empty", Toast.LENGTH_LONG)
                                .show();
                        return;
                    }
                }
                ...
                if (contactMode.equals(InsertCommunicationJson.CONTACT_MODE_PHONE)
                    ...
                    if (userInfo.user_phone.isEmpty()) {
                        Toast.makeText(getContext(), "Phone cann't be empty", Toast.LENGTH_LONG)
                                .show();
                        return;
                    }
                }
                ...
                if (contactMode.equals(InsertCommunicationJson.CONTACT_MODE_BRANCH)) {
                    ...
                    if (contactDate == null || contactDate.isEmpty()) {
                        Toast.makeText(getContext(), "Date cann't be empty", Toast.LENGTH_LONG)
                                .show();
                        return;
                    }
                    ...
                    public void onProgress() {
                        ...
                        if (insertTransferresponse.isSuccess()) {
                            myHandler.post(new Runnable() {
                                @Override
                                public void run() {
                                    mGaTracker1.sendView("event.contact.send.request");
                                    DialogManager
                                            .createMessageDialog(                                           		
    ...
    private void initObject() {
        ...
        objectContainer.init(tablesResponseModel.getTableWrapper("COMM_TOPIC")
                .getTableContentList());
