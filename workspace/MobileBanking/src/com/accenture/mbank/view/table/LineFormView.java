...
public class LineFormView extends FormView {
    ...
    int xyColor = Color.rgb(172, 72, 255);

    /**
     * 折点有焦点时的颜色
     */
    int xyTouchColor = Color.argb(100, 172, 72, 255);

    /**
     * 圆矩形的颜色
     */
    int xyDetailColor = Color.argb(200, 172, 72, 255);
    ...
    public LineFormView(Context context) {
        super(context);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (touchPoint > -1 && showDetail) {
            ...
            if (start_x < yAxisXPosition) {

                start_x = yAxisXPosition+detailTouchY;
