...
public class GetBranchListJson {
     ...
     * @return
     */
    public static String GetBranchListReportProtocal(RequestPublicModel publicModel, double latitude,
            double longitude, int range, String searchText) {
        String result = null;
        try {
            ...
            branchListObj.put("customerCode", publicModel.getCustomerCode());
