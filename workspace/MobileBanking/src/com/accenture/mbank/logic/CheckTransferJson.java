...
public class CheckTransferJson {
    ...
    public static CheckTransferResponseModel ParseCheckTransferResponse(String json) {
        ...
        try {
            ...
            checkTransferResponse.setResultDescription(checkTransferResponseObj
                    .optString("resultDescription"));
            // if(checkTransferResponse.getResultCode() != 0){
            JSONObject eventManagementObj = checkTransferResponseObj
                    .getJSONObject("eventManagement");
            checkTransferResponse.responsePublicModel.eventManagement
            ...
            JSONObject bankInformationObj = checkTransferResponseObj
                    .getJSONObject("bankInformation");
    ...
    public static String CheckTransferReportProtocal(String accountCode, double amount,
            ...
            String executionDate, DestaccountModel destaccount, RequestPublicModel publicModel,
            String currency) {
