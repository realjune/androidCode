...
public class CheckSimTopUpJson {
    public static String CheckSimTopUpReportProtocal(RequestPublicModel publicModel,
            ...
            String phoneNumber, String currency) {
        String result = null;
        try {
            ...
            if (amountAvailableList != null) {
                for (int i = 0; i < amountAvailableList.size(); i++) {
                    AmountAvailable amountAvailable = amountAvailableList.get(i);

                    if (amountAvailable != null) {
                        JSONObject obj = new JSONObject();
                        obj.put("commissionAmount", amountAvailableList.get(i)
                                .getCommissionAmount());
    ...
    public static CheckSimTopUpResponseModel ParseCheckSimTopUpResponse(String json) {
        ...
        try {
            ...
            checksimTopUpResponse.responsePublicModel.setResultCode(checksimTopUpObj
                    .getInt("resultCode"));
            checksimTopUpResponse.responsePublicModel.setResultDescription(checksimTopUpObj
            ...
            if (checksimTopUpResponse.responsePublicModel.getResultCode() != 0) {
                ...
                checksimTopUpResponse.responsePublicModel.eventManagement
            ...
            checksimTopUpResponse.responsePublicModel.setTransactionId(checksimTopUpObj
                    .optString("transactionId"));
            checksimTopUpResponse.setBranchDescription(checksimTopUpObj
                    .optString("branchDescription"));
            ...
            checksimTopUpResponse.setPinIsNotRequired(checksimTopUpObj
                    .optString("pinIsNotRequired"));
