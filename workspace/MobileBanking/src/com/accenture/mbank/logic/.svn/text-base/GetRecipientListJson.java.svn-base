...
public class GetRecipientListJson {/**
    ...
    public static GetRecipientListModel parseGetRecipientListResponse(String json) {
        ...
        try {
            ...
            getRecipientList.responsePublicModel.setTransactionId(getRecipientListObj
                    .optString("transactionId"));

            JSONArray bankRecipientListArray = getRecipientListObj
                    .getJSONArray("bankRecipientList");
