    ...
    public void showChart() {
        ...
        if (chartLayout != null) {
            ...
            if (index >= 0 && index < list.size()) {
                ...
                // installments = installments.subList(begin, todayIndex);

                int min = Math.min(12, todayIndex);
                // 今天剩下的
                ...
                for (int i = 0; i < newInstallments.size(); i++) {
                    ...
                    String time = TimeUtil.changeFormattrString(inModel.getDeadlineDate(),
