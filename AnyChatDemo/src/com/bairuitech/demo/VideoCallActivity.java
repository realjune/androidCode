...
public class VideoCallActivity extends Activity implements AnyChatBaseEvent{
    ...
    {   
        ...
        //ScrollView svUser = new ScrollView(this);
        //svUser.addView(userListView,new LayoutParams(ScreenInfo.WIDTH,ScreenInfo.HEIGHT*3/10));
		mainLayout.addView(userListView,new LayoutParams(ScreenInfo.WIDTH,ScreenInfo.HEIGHT*3/10));
		

    	fullLayout.addView(mainLayout,new LayoutParams(ScreenInfo.WIDTH,ScreenInfo.HEIGHT));
